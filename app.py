...
# --- Load Data ---
df = pd.read_csv("tata_motors_sales_data.csv", parse_dates=['Date'])

# --- Image Assets ---
CAR_IMAGES = {
    "Tiago": "images/Tiago.jpeg",
    "Tiago EV": "images/Tiago.jpeg",
    "Harrier": "images/Harrier.jpeg",
    "Safari": "images/Safari.jpeg",
    "Nexon": "images/Nexon.jpeg",
    "Punch": "images/Punch.jpeg",
    "Curvv": "images/Curvv.jpeg"
}
TATA_LOGO = "images/Tata Motors logo.png"
...
selected_city = st.sidebar.selectbox("City", city_options, key="city", help="Select city")
selected_year = st.sidebar.selectbox("Year", year_options, key="year", help="Select year")
selected_region = st.sidebar.selectbox("Region", region_options, key="region", help="Select region")
selected_model = st.sidebar.selectbox("Model", model_options, key="model", help="Select car model")
